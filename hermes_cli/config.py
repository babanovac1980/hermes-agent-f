...
OPTIONAL_ENV_VARS = {
    ...
    "JELLYFIN_API_KEY": {
        "description": "Jellyfin API key (alternative to JELLYFIN_USER+PASSWORD)",
    ...
    "JELLYFIN_USER": {
        "description": "Jellyfin username (used with JELLYFIN_PASSWORD instead of API key)",
        "prompt": "Jellyfin username",
        "url": None,
        "tools": ["jellyfin_search", "jellyfin_library_stats", "jellyfin_get_details",
                  "jellyfin_similar", "jellyfin_recent", "jellyfin_all_movies"],
        "password": False,
    ...
    "JELLYFIN_PASSWORD": {
        "description": "Jellyfin password (used with JELLYFIN_USER instead of API key)",
        "prompt": "Jellyfin password",
        "url": None,
        "tools": ["jellyfin_search", "jellyfin_library_stats", "jellyfin_get_details",
                  "jellyfin_similar", "jellyfin_recent", "jellyfin_all_movies"],
        "password": True,
